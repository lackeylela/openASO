# -*- coding: utf-8 -*-
"""
Created on Thu Apr  1 20:52:38 2021

@author: Chung
"""
import pandas as pd

with open('../Data/Features/MFE_features_ASOs_bindingSites.txt') as f:
    txt = f.read()
txt = txt.split('\n')[:-1]
...
for i in range(21):
    column_names += ['MFE' + str(i+1)]
data_new.columns = column_names

#data_new = pd.read_csv('../Data/Features/MFE_features_ASOs_bindingSites.txt', delimiter="\t", header=None)
data = pd.read_csv('../Data/openASO_gr_All+RBP+UTR.tsv', delimiter="\t")
...
data.to_csv('../Data/openASO_gr_All+RBP+UTR+MFE.tsv', sep='\t')